...
public class SubscribeService {
    ...
    public void firstSubscribe(CustomUserDetails userDetails){
        ...
        Boolean existsSubscribe = user.getIsSubscribed();
    ...
    public void savaUserKeyword(CustomUserDetails userDetails, KeywordSubscribeRequest keywordList){
        ...
        for( String keyword : categories){
            System.out.println("요청 타입: " + keyword);
            // 각 레코드와 유저 데이터를 유저키워드에 저장하는 로직 구현
            keywordOb = keywordRepository.findByKeyword(keyword);
            ...
            subscribeRepository.save(userKeywordOb);
